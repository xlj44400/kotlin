...
val test0p2 = P2(1, 1)
val <!NI;IMPLICIT_INTERSECTION_TYPE!>test0p2a<!> = P2(1, "")
...
val <!NI;IMPLICIT_INTERSECTION_TYPE!>test3pr<!> = P2<!WRONG_NUMBER_OF_TYPE_ARGUMENTS!><String, Int, Int><!>(<!OI;CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!>, "")
