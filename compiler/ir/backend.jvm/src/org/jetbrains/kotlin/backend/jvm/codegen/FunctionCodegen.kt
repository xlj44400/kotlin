...
open class FunctionCodegen(
    ...
    private fun calculateMethodFlags(isStatic: Boolean): Int {
        ...
        val strictFpFlag = irFunction.annotations.findAnnotation(STRICTFP_ANNOTATION_FQ_NAME)?.let { Opcodes.ACC_STRICT } ?: 0
        val synchronizedFlag = irFunction.annotations.findAnnotation(SYNCHRONIZED_ANNOTATION_FQ_NAME)?.let { Opcodes.ACC_SYNCHRONIZED } ?: 0
