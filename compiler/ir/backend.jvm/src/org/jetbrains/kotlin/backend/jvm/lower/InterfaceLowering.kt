...
import org.jetbrains.kotlin.backend.jvm.ir.isJvmDefault
    ...
    override fun lower(irClass: IrClass) {
        ...
        for (function in irClass.declarations) {
            ...
            if (function.modality != Modality.ABSTRACT && function.origin != IrDeclarationOrigin.FAKE_OVERRIDE) {
                ...
                if (function.isJvmDefault(context) && function.origin != JvmLoweredDeclarationOrigin.SYNTHETIC_METHOD_FOR_PROPERTY_ANNOTATIONS) {
