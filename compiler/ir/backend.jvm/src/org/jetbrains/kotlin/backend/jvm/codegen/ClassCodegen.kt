...
private val IrField.flags: Int
    get() = origin.flags or visibility.flags or
            ...
            (annotations.findAnnotation(VOLATILE_ANNOTATION_FQ_NAME)?.let { Opcodes.ACC_VOLATILE } ?: 0) or
            (annotations.findAnnotation(TRANSIENT_ANNOTATION_FQ_NAME)?.let { Opcodes.ACC_TRANSIENT } ?: 0)
