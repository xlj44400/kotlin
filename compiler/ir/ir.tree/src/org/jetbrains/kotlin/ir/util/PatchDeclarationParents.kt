...
class PatchDeclarationParentsVisitor() : IrElementVisitorVoid {
    ...
    override fun visitProperty(declaration: IrProperty) {
        declaration.getter?.let { it.correspondingPropertySymbol = declaration.symbol }
        declaration.setter?.let { it.correspondingPropertySymbol = declaration.symbol }
        declaration.backingField?.let { it.correspondingPropertySymbol = declaration.symbol }
